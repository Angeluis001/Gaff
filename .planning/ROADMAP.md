...
Plans:
- [x] 09-01-PLAN.md — Foundation: git submodule marketingskills, product-marketing-context.md, Lead Agent psychology enrichment, follow-up sequence rewrite
- [x] 09-02-PLAN.md — SEO + Reviews upgrade: pSEO slug architecture, /fishing-reports/[slug] public route, schema.org Article markup, llms.txt, Reviews Agent brand voice
- [x] 09-03-PLAN.md — Marketing upgrade: LLM caption generation with social-content hook formulas, competitor-anchored prompts, comment reply drafts
- [x] 09-04-PLAN.md — CRM upgrade: LLM email content generation for anniversary/seasonal/re-engagement campaigns with email-sequence and churn-prevention frameworks
