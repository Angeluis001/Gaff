...
function buildGuidance(knowledgeUrl, reservationUrl) {
	return [
...
var gaff_assistant_default = definePluginEntry({
	...
	register(api) {
		...
		api.registerTool({
			...
			description: "Fetch the canonical GAFF knowledge export for FAQs, booking rules, contacts, and source-of-truth URLs.",
			parameters: {
				type: "object",
