...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-24 right-6 z-40 flex size-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg transition hover:bg-[#20bc5a] hover:scale-105"
    >
